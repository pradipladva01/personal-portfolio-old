...
import Pradip from '../resources/images/about_pradip.svg'
        ...
        <>
            ...
            <section className="about_area">
                <div className="container">
                    <div className='d-flex about_me_wrap align-items-start mb-30'>
                        <div className="about_image_box shadow_box">
