          ...
          <div className="gx-row d-flex">
            ...
            <div className="credential_content flex-1">
              <div className="credential_about" data-aos="zoom-in">
                <h2>About Me</h2>
                <p>
                  I'm Pradip Ladva a passionate front-end developer with 2 years
                  of experience crafting immersive and user-friendly web
                  experiences. My love for coding and creating visually
                  appealing interfaces led me to specialize in front-end
                  technologies, and I find joy in bringing designs to life
                  through clean, elegant code.
                </p>
                <p>
                  As a front-end developer, my focus is on building responsive
                  and interactive websites and web applications. I'm well-versed
                  in HTML, CSS, and JavaScript, and I thrive on turning complex
                  design concepts into pixel-perfect reality. I have hands-on
                  experience with modern front-end frameworks like React Js and
                  continuously seek ways to improve web performance and user
                  experience.
                </p>
              </div>
              <div className="credential_edc_exp credential_experience">
                ...
                <div className="credential_edc_exp_item" data-aos="zoom-in">
                  ...
                  <p>
                    As a web designer in a design agency, I created a responsive
                    website for a local restaurant. Through close collaboration
                    with the client, I understood their brand identity and
                    preferences. After wireframing and designing mockups, I used
                    HTML, CSS, and JavaScript to deliver a modern, visually
                    appealing site that improved user experience and attracted
                    more online customers, garnering positive feedback.
                  </p>
                </div>
                <div className="credential_edc_exp_item" data-aos="zoom-in">
                  ...
                  <h5>UniQual ITech</h5>
                  <p>
                    As a front-end developer at Uniqual ITech I contributed to
                    innovative projects, utilizing cutting-edge technologies
                    like React JS. I thrived in a collaborative environment,
                    working with designers and back-end developers to deliver
                    exceptional user experiences. Agile development allowed me
                    to adapt quickly, while continuous learning and client
                    collaboration fueled my growth and success.
                  </p>
                </div>
              </div>
